...
func NewClient() *Client {
	return &Client{gorequest.New()}
}

// TraceEnd TraceEnd
func (h *Client) TraceEnd(ctx context.Context) (res *http.Response, body string, errs []error) {
...
// TraceEndByte TraceEndByte
func (h *Client) TraceEndByte(ctx context.Context) (res *http.Response, body []byte, errs []error) {
	if !opentracing.IsGlobalTracerRegistered() {
		return h.EndBytes()
	}
	respSpan, _ := opentracing.StartSpanFromContext(
