...
func (sm *Map) read(ctx context.Context, key string) (*syncMapItem, error) {
...
func (sm *Map) Contains(ctx context.Context, key string) bool {
...
func (sm *Map) Fetch(ctx context.Context, key string) (string, error) {
...
func (sm *Map) FetchMulti(ctx context.Context, keys []string) map[string]string {
...
func (sm *Map) Flush(ctx context.Context) error {
	sm.storage = &sync.Map{}
	return nil
}

// Save a value in SyncMap storage by key
func (sm *Map) Save(ctx context.Context, key string, value string, lifeTime time.Duration) error {
	duration := int64(0)
...
func (sm *Map) AddTracingHook() {

}

// AddMetricHook AddMetricHook
func (sm *Map) AddMetricHook() {

}

// Ping Ping
func (sm *Map) Ping() error {
	return nil
}
